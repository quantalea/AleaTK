...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="referenceContent" class="container-fluid">
                ...
                <div class="col-md-6" id="main" style="margin-top: 30px;">
                  ...
                  <div class="row">
                    <div class="col-md-10">
                      $abstractHtml$
                      <ul>
                          <li>Download the <a href=$sourceCodeLink$>application</a></li>
                          <li>Browse the <a href=$gitLink$>source code</a></li>
                      </ul>
                    </div>
                    <div class="col-md-2">
